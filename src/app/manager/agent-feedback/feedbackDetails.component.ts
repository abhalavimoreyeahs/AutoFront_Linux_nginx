...
export class FeedbackDetailsComponent implements OnInit {
    ...
    displayDummyData = ['S No','customerName','customerMobNo','callType', 'agent','descrptionOnCall','createdAt']
    constructor(private toastrService: ToastrService, private formBuilder: FormBuilder, private service:  ManagerService,  public dialog: MatDialog) {
